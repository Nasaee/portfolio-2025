...
const textLang = {
  ...
  th: {
    ...
    name: "Nasaee",
    subHeader:
      "ผมเป็นนักพัฒนา Full-stack ที่หลงใหลในการสร้างเว็บแอปที่ทันสมัย ตอบสนองไว และใช้งานง่าย ความเชี่ยวชาญของผมรวมถึง React, Node.js และเทคโนโลยีเว็บใหม่ ๆ ผมชอบสร้างโซลูชันที่เรียบง่ายและมีประสิทธิภาพ พร้อมเรียนรู้อย่างต่อเนื่องเพื่อนำเทรนด์อุตสาหกรรม มาร่วมกันทำให้ไอเดียของคุณเป็นจริงครับ!",
  },
};
